function [simbolos_pam,bits_simbolo,color_plot]=codifica_secuencial_pam(bits,M);
%-------------------------------------------------------------------------
...
%
%  [simbolos_pam,bits_simbolo,color_plot]=codifica_secuencial_pam(bits,M);
%
...
% of a M-PAM constellation using sequential encoding
%
%  [simbolos_pam,bits_simbolo,color_plot]=codifica_secuencial_pam(bits,M);
%
