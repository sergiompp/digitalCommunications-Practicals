function [simbolos_qam,bits_simbolo,color_plot]=codifica_secuencial_qam(bits,M);
%-------------------------------------------------------------------------
% Funcion que transforma una secuencia de bits en una secuencia de s�mbolos
% de una constelaci�n M-PAM siguiendo una codificaci�n secuencial
%
%  [simbolos_pam,bits_simbolo,indices]=codifica_secuencial_qam(bits,M);
%
...
% of a M-QAM constellation using sequential encoding
%
%  [simbolos_qam,bits_simbolo,color_plot]=codifica_secuencial_qam(bits,M);
%
...
simbolos_qam_I=codifica_secuencial_pam(bits_I,M2);
simbolos_qam_Q=codifica_secuencial_pam(bits_Q,M2);
